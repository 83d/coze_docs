原文地址：https://docs.coze.cn/guides/private_link
...
| 地域要求 | 你的服务需要部署在火山引擎**华北 2** 地域，其他地域暂不支持与扣子编程进行私网连接。  如果你有其他地域的服务，希望使用私网连接功能，可以联系扣子技术支持，将需求同步给扣子团队评估。 |
...
详细的配置步骤可参考[通过私网连接访问扣子 API](https://docs.coze.cn/dev_how_to_guides/access_api_over_vpc)。
...
<img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/d3b6a339f6484aa6aadba3e6c5150f5f~tplv-goo7wpa0wc-quality:q75.awebp" width="600">
...
<img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/e03b3fa9e1674fe1a6ebb58c644ad10c~tplv-goo7wpa0wc-quality:q75.awebp" width="700">
...
<img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/85995fdc2cc54e60a7d57dd28b0cc37d~tplv-goo7wpa0wc-quality:q75.awebp" width="436">
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/5fa06c9ecb2541d385a9bfed10ad4135~tplv-goo7wpa0wc-quality:q75.awebp" width="600">
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/f51d93bf4c2143b090d5f926b6cc73f3~tplv-goo7wpa0wc-quality:q75.awebp" width="700">
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/9261d480363548449965c52b8ff27c00~tplv-goo7wpa0wc-quality:q75.awebp" width="500">
...
-
  ...
  | 跨账号授权 | 默认只能使用同一个火山引擎主账号下的终端节点服务。如需使用其他火山引擎账号下的私网连接，你需要给扣子编程对应的火山引擎主账号授权终端节点服务的访问权限，具体步骤请参见[跨账号授予私网连接的访问权限](https://docs.coze.cn/guides/private_link)。  请填写访问控制中创建的角色的角色 TRN。例如：  trn:iam::21020\*\*\*:role/CozePrivateLinkEndpointRole。   <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/36788e0ba87e47159e90ef51c7cde62c~tplv-goo7wpa0wc-quality:q75.awebp" width="400">  |
  | 自定义 DNS 解析 | 仅当步骤三中启用 DNS 私有名称并验证通过后，方可开启此开关。  开启后，你需要在创建私网模式插件时配置域名前缀，扣子编程即可访问插件对应的服务。具体操作请参见[创建私网模式插件](https://docs.coze.cn/guides/private_plugin)。 |
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/abe6ddfa637b4f94aac939a4712edc9d~tplv-goo7wpa0wc-quality:q75.awebp" width="714">
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/db1637ffaf84463a9ecf4bb27ea2c876~tplv-goo7wpa0wc-quality:q75.awebp" width="700">
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/3836c5db8f3e46fba0260195d59319ea~tplv-goo7wpa0wc-quality:q75.awebp" width="600">


#### 步骤五：创建并使用私网插件

创建私网连接后，你可以创建并使用私网模式的插件，具体操作请参见[创建私网模式插件](https://docs.coze.cn/guides/private_plugin)。
...
<img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/bcbcb02c30a942cdbfff8016756c8fc5~tplv-goo7wpa0wc-quality:q75.awebp" width="700">
...
<img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/1604c966ecfa4a358f7213cdd70e0f01~tplv-goo7wpa0wc-quality:q75.awebp" width="700">
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/4c529252f182493d9df65dd6d22b5fa0~tplv-goo7wpa0wc-quality:q75.awebp" width="400">
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/0f2afa67a9324a7aa9efbe891e328547~tplv-goo7wpa0wc-quality:q75.awebp" width="400">
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/4792c9a0ccdb46739ece502e487b0eb8~tplv-goo7wpa0wc-quality:q75.awebp" width="400">
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/0998b03485b04960a65a325c57670c89~tplv-goo7wpa0wc-quality:q75.awebp" width="400">
...
- 在**私网连接** > **终端节点连接**页面，**拒绝**扣子终端节点的连接，具体操作请参见[断开私网连接](https://docs.coze.cn/guides/private_link)。
