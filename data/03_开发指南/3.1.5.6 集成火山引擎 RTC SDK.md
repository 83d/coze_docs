原文地址：https://docs.coze.cn/dev_how_to_guides/rtc_sdk
...
- 搭建智能体，详细步骤请参见[搭建一个低代码智能体](https://docs.coze.cn/guides/agent_quick_start)。

- 发布智能体为 API 服务，详细步骤请参见[发布为 API 服务](https://docs.coze.cn/guides/publish_agent_api)。
...
1. 调用[创建房间](https://docs.coze.cn/developer_guides/create_room) API 创建房间。

- 调用扣子编程提供的[创建房间](https://docs.coze.cn/developer_guides/create_room) API，创建一个房间，并将指定的智能体加入房间，然后才能调用 RTC SDK 和智能体开始音视频通话。
