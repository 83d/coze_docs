原文地址：https://docs.coze.cn/cozeloop/crewai_trace_report
...
| OTEL\_EXPORTER\_OTLP\_TRACES\_ENDPOINT  | 指定 OpenTelemetry Trace 数据的上报地址，固定为 https://api.coze.cn/v1/loop/opentelemetry/v1/traces。  |
...
os.environ['OPENAI\_BASE\_URL'] = 'https://ark.cn-beijing.volces.com/api/v3' # use ark model url by default, refer: https://www.volcengine.com/docs/82379/1361424

os.environ['OPENAI\_API\_KEY'] = '\*\*\*' # 设置一个大模型的api key

os.environ["OTEL\_EXPORTER\_OTLP\_ENDPOINT"] = "https://api.coze.cn/v1/loop/opentelemetry/v1/traces"

os.environ["OTEL\_EXPORTER\_OTLP\_HEADERS"] = "cozeloop-workspace-id=\*\*\*,Authorization=Bearer \*\*\*"
...
CrewAIInstrumentor().instrument(skip\_dep\_check=True)
...
<img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/f7dfa8ea834c4c6ab614a91371979697~tplv-goo7wpa0wc-quality:q75.awebp" width="719">
