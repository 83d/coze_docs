原文地址：https://docs.coze.cn/cozeloop/prompt-version-tag-for-go-sdk
...
在扣子罗盘中提交 Prompt 版本时，如果设置了版本标识，即可在 SDK 中通过GetPrompt方法指定prompt\_key和label来获取该版本的 Prompt 详细信息。
...
> -
>
>   prompt, \_ := client.GetPrompt(ctx, cozeloop.GetPromptParam{PromptKey: "prompt\_hub\_test", Version: "0.0.1", Label: "production"})
>
>
>
