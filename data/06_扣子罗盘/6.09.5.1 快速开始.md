原文地址：https://docs.coze.cn/cozeloop/quick-start-nodejs
...
在使用扣子罗盘 Node SDK 前，确保你已经完成了授权。详情请参考[SDK 鉴权](https://docs.coze.cn/cozeloop/authentication-for-sdk)。
...
\* \* process.env.COZELOOP\_API\_BASE\_URL
...
\* use process.env.COZELOOP\_API\_TOKEN when unprovided
...
const resp = await apiClient.post('/v1/api\_url', {/\*\* data \*/});
...
COZELOOP\_TRACE\_BUSINESS\_TAGS,
...
[COZELOOP\_TRACE\_BUSINESS\_TAGS.MODEL\_NAME]: 'custom-model',

[COZELOOP\_TRACE\_BUSINESS\_TAGS.MODEL\_PROVIDER]: 'cozeloop',

[COZELOOP\_TRACE\_BUSINESS\_TAGS.CALL\_OPTIONS]: {
...
[COZELOOP\_TRACE\_BUSINESS\_TAGS.INPUT\_TOKENS]: 100,

[COZELOOP\_TRACE\_BUSINESS\_TAGS.OUTPUT\_TOKENS]: 200,

[COZELOOP\_TRACE\_BUSINESS\_TAGS.TOKENS]: 300,
...
[COZELOOP\_TRACE\_BUSINESS\_TAGS.START\_TIME\_FIRST\_RESP]: 1741305600123456,
...
import { ROOT\_CONTEXT } from '@opentelemetry/api';
...
// setting context to ROOT\_CONTEXT, you don't need to take this step in real cross-service calls
...
const prompt1 = await hub.get('your\_prompt\_key', '0.0.1')

// get prompt with latest version

const prompt2 = await hub.get('your\_prompt\_key')
...
|  | [large\_text.ts](https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/large-text.ts) | 实现超大文本上报。 |
|  | [multi\_modality.ts](https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/multi-modality.ts) | 实现多模态数据上报。 |
