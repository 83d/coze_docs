原文地址：https://docs.coze.cn/cozeloop/opentelemetry_spring_ai_trace_report
...
>
> - 本示例以 Spring AI 1.0.0-M8 版本为例。具体说明，请参考[Spring AI 版本须知](https://docs.coze.cn/cozeloop/opentelemetry_spring_ai_trace_report)。
...
package spring.ai.example.spring\_ai\_demo;
...
public class Application\_tool {

public static void main(String[] args) {

SpringApplication app = new SpringApplication(Application\_tool.class);
...
CommandLineRunner cli\_tool(ChatClient.Builder builder) {
...
<img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/3137ff66314b4979b32af180b67187ff~tplv-goo7wpa0wc-quality:q75.awebp" width="662">
...
headers.put("Authorization", "Bearer pat\_AyJcG40P6TeIQLJENe6QpVuGs3SiJ3t\*\*\*\*");
...
<img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/16b8f77e05c84914a14e8318ebf40ccb~tplv-goo7wpa0wc-quality:q75.awebp" width="681">
