原文地址：https://docs.coze.cn/cozeloop/eino_trace_report
...
openAIBaseURL := os.Getenv("OPENAI\_BASE\_URL")

openAIAPIKey := os.Getenv("OPENAI\_API\_KEY")

modelName := os.Getenv("OPENAI\_MODEL\_NAME")

cozeloopApiToken := os.Getenv("COZELOOP\_API\_TOKEN")

cozeloopWorkspaceID := os.Getenv("COZELOOP\_WORKSPACE\_ID") // use cozeloop trace, from https://loop.coze.cn/open/docs/cozeloop/go-sdk#4a8c980e
...
systemTpl := `你是一名房产经纪人，结合用户的薪酬和工作，使用 user\_info API，为其提供相关的房产信息。邮箱是必须的`

chatTpl := prompt.FromMessages(schema.FString,

schema.SystemMessage(systemTpl),

schema.MessagesPlaceholder("message\_histories", true),
...
nodeModel = "node\_model"

nodeTools = "node\_tools"

nodeTemplate = "node\_template"

nodeConverter = "node\_converter"
...
<img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/af6c173ee8d54914a3a481deda2b666e~tplv-goo7wpa0wc-quality:q75.awebp" width="739">
