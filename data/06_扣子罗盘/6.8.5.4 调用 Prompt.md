原文地址：https://docs.coze.cn/cozeloop/ptaas-for-nodejs-sdk
...
- **token**：扣子罗盘访问密钥，应具备 executePrompt 权限。获取密钥及授权方式可参考[SDK 鉴权](https://docs.coze.cn/cozeloop/authentication-for-sdk)。
...
// or set it as process.env.COZELOOP\_WORKSPACE\_ID,
