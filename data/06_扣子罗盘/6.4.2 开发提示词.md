原文地址：https://docs.coze.cn/cozeloop/create-prompt
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/12719ff0195e41c4a12ddda90776ba37~tplv-goo7wpa0wc-quality:q75.awebp" width="2884">
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/d8abb31df7974f4d8bd087f4c1ee095c~tplv-goo7wpa0wc-quality:q75.awebp" width="383">
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/9a02d3cf87d64f63972014e867fe1ada~tplv-goo7wpa0wc-quality:q75.awebp" width="460">
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/f0ca2171467f431dbacd759b567e2cb1~tplv-goo7wpa0wc-quality:q75.awebp" width="423">
...
<img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/694a1b2cc3764d47898d45fd76919dfc~tplv-goo7wpa0wc-quality:q75.awebp" width="837">
...
详细说明，可参考[编写提示词](https://docs.coze.cn/cozeloop/prompt)。
...
<img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/5a492218f52a4b528ab69a8ab5b35830~tplv-goo7wpa0wc-quality:q75.awebp" width="809">

以普通调试模式为例，你可以在 **Prompt 开发**页面的**预览与调试**区域，直接输入一个指令，然后单击**运行**；或者在 **Prompt 变量**中输入指令信息，然后直接单击**运行**。

方式一：

<img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/810844fbafd947ee9c463cebf9720383~tplv-goo7wpa0wc-quality:q75.awebp" width="2732">

方式二：

<img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/a18b9292db144c4bbdccc5d7bdeb5d9d~tplv-goo7wpa0wc-quality:q75.awebp" width="2736">

因为开启了单步调试模式，所以可以在调试过程中，手动修改函数的模拟返回值。这里，我们将上海的天气改为Rainy。

<img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/d53a77b7e4ea438d95495eff5828a922~tplv-goo7wpa0wc-quality:q75.awebp" width="289">
...
关于 Prompt 调试模式的详细说明，可参考[调试提示词](https://docs.coze.cn/cozeloop/debug-prompt)。

# 步骤四：提交并管理 Prompt

当完成 Prompt 调试与优化，模型可以输出预期结果后，可提交当前的 Prompt 配置，并生成一个版本号。后续，可以选择指定的 Prompt 版本进行效果评测和链路追踪。发布版本后如何管理提示词版本，可参考[管理提示词版本](https://docs.coze.cn/cozeloop/prompt_version)。
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/51238ad9816240c68e151cd0a3896bf0~tplv-goo7wpa0wc-quality:q75.awebp" width="397">
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/a25b20a406d9449db2d28623c2601731~tplv-goo7wpa0wc-quality:q75.awebp" width="424">
...
- 对 Prompt 效果进行评估，参考[评测入门教程](https://docs.coze.cn/cozeloop/evaluation-quick-start)。

- 实时观测 Prompt 消息链路，参考[查看 Trace 数据](https://docs.coze.cn/cozeloop/trace-data)。

- 接入扣子罗盘 SDK，获取 Prompt 配置。参考[SDK 概述](https://docs.coze.cn/cozeloop/sdk)。
