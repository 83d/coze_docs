原文地址：https://docs.coze.cn/developer_guides/update_dataset
...
> **说明**
>
> - 此接口会全量刷新知识库的 name、file\_id 和 description 配置，如果未设置这些参数，参数将恢复默认配置。
>
...
| **请求方式** | PUT |
| --- | --- |
| **请求地址** |  https://api.coze.cn/v1/datasets/:dataset\_id  |
...
curl --location --request PUT 'https://api.coze.cn/v1/datasets/:dataset\_id' \
