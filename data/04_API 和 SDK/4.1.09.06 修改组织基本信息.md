原文地址：https://docs.coze.cn/developer_guides/update_organization_info
...
| **请求方式** | PUT |
| --- | --- |
| **请求地址** |  https://api.coze.cn/v1/organizations/:organization\_id  |
...
| **参数** | **类型** | **是否必选** | **示例** | **说明** |
| --- | --- | --- | --- | --- |
| organization\_id | String | 必选 | 7559861372637\*\*\* | 待修改组织信息的组织 ID。   你可以在**组织管理** > **组织设置**页面查看对应的组织 ID，或通过[查询组织列表](https://docs.coze.cn/developer_guides/list_organization) API 查询组织 ID。   <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/b57d5e293ff944d2b83efe8217d35517~tplv-goo7wpa0wc-quality:q75.awebp" width="500">  |
