原文地址：https://docs.coze.cn/developer_guides/chat_v3
...
-
  ...
  <img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/47ae41fd2e864943adee2a872eaec23b~tplv-goo7wpa0wc-quality:q75.awebp" width="500">
...
扣子编程也支持 Jinja2 语法。在下面这个模板中，prompt1 将在 key 变量存在时使用，而 prompt2 将在 key 变量不存在时使用。通过在 custom\_variables 中传递 key 的值，你可以控制智能体的响应。
...
2. 调用[创建会话](https://docs.coze.cn/developer_guides/create_conversation)接口创建一个会话，其中包含以上两条消息，并记录会话 ID。
...
4. 调用接口[查看对话消息详情](https://docs.coze.cn/developer_guides/list_chat_messages)查看模型回复。
