原文地址：https://docs.coze.cn/developer_guides/update_workspace_info
...
| **请求方式** | PUT |
| --- | --- |
| **请求地址** |  https://api.coze.cn/v1/workspaces/:workspace\_id  |
...
| **参数** | **类型** | **是否必选** | **示例** | **说明** |
| --- | --- | --- | --- | --- |
| workspace\_id | String | 必选 | 736163827687053\*\*\*\* | 需要修改工作空间信息的工作空间 ID。  进入指定空间，空间页面 URL 中 w 参数后的数字就是 工作空间 ID。例如https://code.coze.cn/w/75814654762959\*\*\*/projects，workspace\_id 为 75814654762959\*\*\*。 |
