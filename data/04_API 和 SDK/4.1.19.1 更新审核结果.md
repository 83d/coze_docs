原文地址：https://docs.coze.cn/developer_guides/update_review_result
...
| **请求方式** | PUT |
| --- | --- |
| **请求地址** |  https://api.coze.cn/v1/connectors/:connector\_id/bots/:bot\_id |
...
| **参数** | **类型** | **是否必选** | **示例** | **说明** |
| --- | --- | --- | --- | --- |
| bot\_id | String | 可选 | 73428668\*\*\*\*\* | 要更新的智能体 ID。  进入智能体的编排页面，编排页面 URL 中 bot 参数后的数字就是智能体 ID。例如https://www.coze.cn/space/341\*\*\*\*/bot/73428668\*\*\*\*\*，智能体 ID 为73428668\*\*\*\*\*。 |
| connector\_id | String | 可选 | 74202797\*\*\*\*\*\* | 渠道 ID。需要跟 token 的渠道一致。 |

### Body

| **参数** | **类型** | **是否必选** | **示例** | **说明** |
| --- | --- | --- | --- | --- |
| audit\_status | Integer | 可选 | 2 | 渠道审核状态。支持设置为：  - 1: 审核中  - 2: 审核通过  - 3: 审核不通过 |
