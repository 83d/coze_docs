原文地址：https://docs.coze.cn/developer_guides/get_metadata
...
| **请求方式** | GET |
| --- | --- |
| **请求地址** |  https://api.coze.cn/v1/bot/get\_online\_info |
...
| **参数** | **类型** | **是否必选** | **示例** | **说明** |
| --- | --- | --- | --- | --- |
| bot\_id | String | 必选 | 73428668\*\*\*\*\* | 要查看的智能体 ID。  进入智能体的 开发页面，开发页面 URL 中 bot 参数后的数字就是智能体 ID。例如[https://www.coze.cn/space/341\*\*\*\*/bot/73428668\*\*\*\*\*](https://www.coze.cn/space/341****/bot/73428668*****)，bot ID 为73428668\*\*\*\*\*。  [!NOTE]  **Tip**  确保该智能体的所属空间已经生成了访问令牌。  |
