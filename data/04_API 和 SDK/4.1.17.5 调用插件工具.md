原文地址：https://docs.coze.cn/developer_guides/call_plugin_tool
...
| **请求方式** | POST |
| --- | --- |
| **请求地址** |  https://api.coze.cn/v1/plugins/:plugin\_id/tools/call  |
...
| **参数** | **类型** | **是否必选** | **示例** | **说明** |
| --- | --- | --- | --- | --- |
| plugin\_id | String | 必选 | 75458732632938\*\*\* | 待执行的插件 ID。你可以调用[查询插件列表](https://docs.coze.cn/developer_guides/list_plugin) API 获取对应的插件 ID，即 entity\_id 的值。 |

## Body

| **参数** | **类型** | **是否必选** | **示例** | **说明** |
| --- | --- | --- | --- | --- |
| tool\_name | String | 必选 | getToutiaoNews | 插件工具的名称。你可以通过[查询插件详情](https://docs.coze.cn/developer_guides/get_plugin) API 获取。 |
...
--header 'Authorization: Bearer pat\_3UXDHN82MgQANqK\*\*\*\*' \

--data-raw '{

"tool\_name": "getToutiaoNews",
...
"news\_society/news\_law/statute",

"news\_society/negative\_energy\_society",

"news\_society/news\_law",
